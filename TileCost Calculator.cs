...
namespace ConsoleApp1
{
    class TileCostCalculator
    {
        static void Main(string[] args)
        {
            ...
            double totalCost = (costPerUnit + (HOURLY_RATE / TIME_PROGRESS)); // variable for calculating total cost depending on area
            ...
            if (floorShape == RECT_FLOOR)
            {
                ...
                double area = length * width; // area calculated
                totalCost = area * totalCost; // need to pay for material and labor
